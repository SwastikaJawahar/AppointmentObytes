 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.appointmentexpo-owner.staging
 */

const BUNDLE_ID = 'com.appointmentowner'; // ios bundle id
const PACKAGE = 'com.appointmentowner'; // android package name
const NAME = 'Appointmentowner'; // app name
